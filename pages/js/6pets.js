...
//make below if statement a var to use in multipet cxl - this is going to be fun =.=
if (parseInt(ServUsed5) < parseInt(WPBAL5) && parseInt(ServUsed5) <= parseInt(InstallPaid5)) {
               
    ///services used cxl

var P5 = "Looking at "+PName5+"'s plan, as all services used have been paid for with the monthly installments we can close the plan today at no cost.";

var note5 = "-adv $0 per Services for "+PName5+" - cxled at $0 ";



} else if (parseInt(ServUsed5) < parseInt(WPBAL5)) {
...
} else if (parseInt(ServUsed5) > parseInt(WPBAL5) && parseInt(WPBAL5) <= parseInt(InstallPaid5)) {
   
    ///services used cxl

var P5 = "Looking at "+PName5+"'s plan, as all 12 monthly installments have been processed, we can close"+PName5+"'s plan today at no cost.";

var note5 = "-adv $0 per WP BAL for "+PName5+" - cxled at $0 ";
...
//make below if statement a var to use in multipet cxl - this is going to be fun =.=
if (parseInt(ServUsed6) < parseInt(WPBAL6) && parseInt(ServUsed6) <= parseInt(InstallPaid6)) {
               
    ///services used cxl

var P6 = "Looking at "+PName6+"'s plan, as all services used have been paid for with the monthly installments we can close the plan today at no cost.";

var note6 = "-adv $0 per Services for "+PName6+" - cxled at $0 ";



} else if (parseInt(ServUsed6) < parseInt(WPBAL6)) {
...
} else if (parseInt(ServUsed6) > parseInt(WPBAL6) && parseInt(WPBAL6) <= parseInt(InstallPaid6)) {
   
    ///services used cxl

var P6 = "Looking at "+PName6+"'s plan, as all 12 monthly installments have been processed, we can close"+PName6+"'s plan today at no cost.";

var note6 = "-adv $0 per WP BAL for "+PName6+" - cxled at $0 ";
